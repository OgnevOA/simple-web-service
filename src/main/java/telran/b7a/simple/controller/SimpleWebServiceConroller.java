...
@RestController
public class SimpleWebServiceConroller {
	...
	@PostMapping("/person")
	public String greetingPerson(@RequestBody PersonDto peronDto) {
		return "Hello" + peronDto.getFirstName() + " " + peronDto.getLastName();
	}
